  ...
  return (
    <form onSubmit={handleAddPost} className="form-container">
      ...
      <div className="mb-3">
        ...
        <textarea rows={4} className="form-control" id="body" ref={bodyElement}/>
      </div>
      ...
      <div className="mb-3">
        ...
        <input type="number" className="form-control" id="reactions" ref={reactionsElement}/>
      </div>
      ...
      <div className="mb-3">
        ...
        <input type="text" className="form-control" id="HashTags"  ref={hashTagsElement}/>
      </div>
